...
class Message(models.Model):
    ...
    class Meta:
        ordering = ('-pub_date',) #-つけることでpub_dateを新しい順にする
...
class Employee(models.Model):
    owner = models.ForeignKey(User,on_delete=models.CASCADE,related_name='employee_owner')
...
class Good(models.Model):
    ...
    def __str__(self) :
        return 'LGTM for"'+str(self.message)+'"(by'+ str(self.owner)+')'